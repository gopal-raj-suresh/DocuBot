...
async def run_writer_agent_sectioned(
    ...
    try:
        ...
        for section_name in planned_sections:
            ...
            section_content, response = await _generate_section(llm, section_name, evidence)
        ...
        # Convert responses to messages format for metrics extraction
...
async def _generate_section(
    ...
    Returns: Tuple of (markdown content, response object)
    """

    # Build section-specific evidence (only relevant data)
    # Map section names to evidence
