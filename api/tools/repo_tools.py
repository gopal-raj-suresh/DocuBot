...
def analyze_code_structure_tool(repo_path: str, file_path: str) -> str:
    ...
    try:
        ...
        # Check if path is a directory (common LLM mistake)
        if os.path.isdir(full_path):
            return f"Error: '{file_path}' is a directory, not a file. Use list_directory() to explore directories, or specify a specific file path to analyze."
